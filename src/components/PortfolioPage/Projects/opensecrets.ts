const opensecrets = {
    text: [
        ...
        `It handles firing requests and marshalling the  JSON response into structs users
        can work with.`,
        ...
        `I wrote the whole thing ignorant of Golang context, then had to rewrite all the public functions to take context as a first param.`,
